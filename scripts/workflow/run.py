...
CONSTRAINTS = ['Constr E9_ModelPeriodEmissionsLimit', 'Constr AAC2_TotalAnnualTechnologyActivityUpperLimit', 'Constr AAC3_TotalAnnualTechnologyActivityLowerLimit', 'Constr CAa4_Constraint_Capacity']
